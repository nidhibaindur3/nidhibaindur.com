...
export default function Header() {
  return (
    <div className="fixed top-6 left-1/2 z-50 flex -translate-x-1/2 items-center space-x-4">
      ...
      {/* Navigation */}
      <nav className="flex h-14 items-center justify-center space-x-2 rounded-2xl border border-white/30 bg-main-theme/20 px-4 shadow-lg ring-1 ring-white/20 backdrop-blur-xl transition-all duration-300 sm:space-x-6 sm:px-8 dark:border-white/10 dark:bg-neutral-900/20">
